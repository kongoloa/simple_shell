...
/**
 * split_buf - tokenizes a string with spaces, tabs and new lines as delimiters
 * @buf: command line passed in by user on standard input, string to be parsed
 * Return: double pointer to an array
 */
...
/**
 * token_count_buf - counts number of strings typed in by user
 * @buf: command line passed in by the user on standard input, string to be parsed
