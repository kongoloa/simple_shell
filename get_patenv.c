...
/**
 * _getenv - gets an environment var
 * @name: pointer to the variable name on target (here, PATH)
 * Return: pointer to the actual environment var
 */
...
/**
 * split_path - tokenizes the PATH string
...
/**
 * token_count_path - counts number of directories in PATH string
 * @path_str: pointer to the PATH string to be parsed, passed by main
...
/**
 * _status - checks the status of a file
